...
export const PulseMark: React.FC<{ size?: number }> = ({ size = 34 }) => (
  <div style={{ width: size, height: size }} aria-hidden="true">
    <svg viewBox="0 0 40 40" width={size} height={size}>
      <circle cx="20" cy="20" r="19" fill="none" stroke="var(--line)" strokeWidth="1.4" />
      <path
        d="M6,21 L14,21 L17,12 L21,29 L24,21 L34,21"
        fill="none"
        stroke="var(--accent)"
        strokeWidth="2"
        style={{ filter: "drop-shadow(0 0 3px var(--accent-soft))" }}
      />
    </svg>
  </div>
);
