...
export const WebsiteAndStorefrontsPage: React.FC<WebsiteAndStorefrontsPageProps> = ({
  ...
  const deliverables = [
    ...
    "Tailored E-commerce Stores & Online Storefronts",
    "Focused Landing Pages & Lead Generation Funnels",
    "Interactive Portfolio & Showcase Websites",
    "Headless & Traditional CMS Integrations",
  ];
  ...
  const features = [
    {
      ...
      description:
        "Modern, fast, and responsive websites engineered to elevate brand credibility and engage visitors.",
    },
    {
      icon: Store,
      title: "Online Stores",
      description:
        "Secure, high-converting e-commerce experiences with seamless checkout and payment gateway integrations.",
    },
    {
      icon: Zap,
      title: "SEO & Performance",
      description:
        "Optimized speed, core web vitals, and search engine visibility to drive organic traffic and conversions.",
    },
  ];
  ...
  const workflow = [
    {
      ...
      description:
        "Defining site structure, conversion funnels, brand alignment, and technical requirements.",
    },
    {
      step: "02",
      title: "Design & Development",
      description:
        "Crafting pixel-perfect layouts, responsive interfaces, and custom CMS or store integrations.",
    },
    {
      step: "03",
      title: "Optimization & Launch",
      description:
        "Conducting speed audits, SEO checks, domain setup, and deploying for a seamless production launch.",
    },
  ];
  ...
  return (
    <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 py-16 md:py-24">
      ...
      >
        ...
        >
          We create fast, modern, and responsive websites and online stores that
          help businesses build credibility, attract customers, and increase sales.
        </p>
      </motion.div>
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-16">
        ...
        >
          ...
          >
            <Layers size={14} /> Core Services & Deliverables
          </div>
