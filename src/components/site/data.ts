...
export const PROJECTS: Project[] = [
  {
    ...
    link: "https://stormymart.en.uptodown.com/android",
    image: "/images/projects/stormymart.png",
  },
  {
    name: "SplitShare",
    category: "Tour costing share",
    desc: "A tour cost sharing platform that allows users to split expenses, track payments, and manage group trips efficiently.",
  ...
  {
    name: "Turf Booking Site",
    category: "Booking Platform · Web App",
    desc: "A turf booking platform that allows users to find and reserve sports facilities online, with real-time availability and secure payment processing.",
    tags: ["TypeScript", "AWS", "Docker"],
    link: "https://turf-booking-site-drab.vercel.app/",
    image: "/images/projects/turfbookingsite.png",
  },
  // NEW DEMO PROJECT 1
  {
    name: "Admin Dashboard for Turf Booking Site",
    category: "Internal Tooling",
    desc: "An admin dashboard for a turf booking site, providing real-time analytics, user management, and system monitoring.",
    tags: ["Next.js", "Python", "FastAPI", "Tailwind CSS"],
    link: "https://admin-dashboard-113v.vercel.app/",
    image: "/images/projects/admin-dashboard-for-turf-booking-site.png",
  },
  // NEW DEMO PROJECT 2
  {
    name: "VelocePay",
