...
interface CloudAndDevOpsPageProps {
  onBack: () => void;
}

export const CloudAndDevOpsPage: React.FC<CloudAndDevOpsPageProps> = ({
  onBack,
}) => {
  useEffect(() => {
    window.scrollTo(0, 0);
  ...
  const deliverables = [
    ...
    "Cloud Migration & Hybrid Cloud Architecture (AWS, GCP, Azure)",
    "24/7 Observability, Logging & Alerting (Prometheus, Grafana, Datadog)",
  ];
  ...
  const features = [
    {
      ...
      description:
        "Architecting highly available, auto-scaling, and cost-optimized infrastructure tailored to enterprise workload needs.",
    },
    {
      icon: GitBranch,
      title: "CI/CD & Automation",
      description:
        "Streamlining release cycles with zero-downtime automated deployment pipelines and robust roll-back protocols.",
    },
    {
      icon: Activity,
      title: "Observability & Security",
      description:
        "Proactive threat monitoring, continuous compliance, and real-time operational visibility to ensure maximum uptime.",
    },
  ];
  ...
  const workflow = [
    {
      ...
      description:
        "Assessing existing infrastructure, security posture, deployment bottlenecks, and defining cloud strategy.",
    },
    {
      step: "02",
      title: "Automation & Migration",
      description:
        "Writing IaC modules, setting up container orchestration, and automating continuous delivery pipelines.",
    },
    {
      step: "03",
      title: "Monitoring & Optimization",
      description:
        "Implementing telemetry dashboards, auto-scaling policies, security hardening, and ongoing cost optimization.",
    },
  ];
  ...
  return (
    <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 py-16 md:py-24">
      ...
      >
        ...
        >
          Engineering resilient cloud architectures and automated delivery pipelines
          to enable continuous release velocity, robust security, and 99.99% system availability.
        </p>
      </motion.div>
